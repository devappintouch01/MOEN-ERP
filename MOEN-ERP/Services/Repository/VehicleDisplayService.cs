...
using MOEN_ERP.Models.ViewModel.VehicleDisplay;
...
namespace MOEN_ERP.Services.Repository
{
    public interface IVehicleDisplayService {
        public Task<ApiResultsModel> GetVehicleDisplayDetailAsync(VehicleDisplayScreenSearch sch);
    }
    public class VehicleDisplayService : IVehicleDisplayService
    {
        private readonly SettingsModel _settings;
        private readonly ITokenService _tokenService;
        public VehicleDisplayService(IOptions<SettingsModel> options, ITokenService tokenService) {
            _settings = options.Value;
            _tokenService = tokenService;
        }


        public async Task<ApiResultsModel> GetVehicleDisplayDetailAsync(VehicleDisplayScreenSearch sch)
        {
            ...
            try
            {
                ...
                var url = $"{_settings.BaseUrlApi}/VehicleDisplay/GetVehicleDisplayDetail";
