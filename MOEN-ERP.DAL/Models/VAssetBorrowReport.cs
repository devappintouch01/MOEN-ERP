...
public partial class VAssetBorrowReport
{
    ...
    public string? ReceiveReturnOfficerName { get; set; }

    public DateTime? ReturnDate { get; set; }

    public DateTime? ReceiveReturnDate { get; set; }

    public string NotApproveDetail { get; set; } = null!;

    public string? LendApprovePositionName { get; set; }
