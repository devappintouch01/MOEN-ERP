...
{
    public class VVehicleBookingAssign
    {
        ...
        public int? DriverPosId { get; set; }

        public string? DriverPosName { get; set; }

        public int? DriverOrgId { get; set; }

        public string? DriverOrgName { get; set; }
        ...
        public string? IsEditableRecorded { get; set; }
